...
Pipeline Inspector 是一款专为 Blender 用户设计的**一站式 3D 资产交付预检工具**，旨在自动化检测模型在导出、上传或提交给客户前可能存在的各种技术问题，确保资产符合交付标准，从而避免返工和提升交付效率。

## Target User

*   **Freelancers (自由职业者)**：需要确保交付给客户的资产质量，避免因技术问题导致的返工和信誉受损。
*   **Game Artists (游戏美术师)**：需要将 Blender 模型导出到游戏引擎（如 Unity, Unreal Engine）并确保其兼容性和性能。
*   **Asset Creators (资产创作者)**：在 Blender Market, Sketchfab, CGTrader 等平台销售 3D 资产，需要符合平台的技术规范和质量标准。
*   **Studio Artists (工作室美术师)**：在团队协作中，需要统一资产质量标准，减少因个人操作失误导致的流水线中断。
*   **Marketplace Sellers (市场卖家)**：希望通过自动化检查，提高资产审核通过率，减少维护成本。

## Core Promise

Pipeline Inspector 承诺帮助 Blender 用户在 3D 资产交付前**自信地发现并解决潜在问题**，确保资产“一次性通过”各种技术和质量检查，从而**节省时间、降低成本，并提升专业声誉**。
